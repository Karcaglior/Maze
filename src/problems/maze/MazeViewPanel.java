...
public class MazeViewPanel extends JPanel{
	...
	// Images
	public static final Image hamster = Toolkit.getDefaultToolkit().getImage("imgs/hamster.png");	
	public static final Image hamsterFull = Toolkit.getDefaultToolkit().getImage("imgs/hamster2.png");	
	public static final Image cheese = Toolkit.getDefaultToolkit().getImage("imgs/queso.png");	
